...
==================================================================
 File        : utils.py
 Description : Provides utility functions for handling the music 
               folder, identifying devices for mountpoints, listing 
               blocking processes, and safely unmounting iPods.
